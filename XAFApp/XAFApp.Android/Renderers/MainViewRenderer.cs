...
using System.Linq;
using XAF.App.Views;
using XAF.App.Views.Core;
using XAFApp.Droid.Renderers;
using Xamarin.Forms;
using Xamarin.Forms.Platform.Android;
using Color = Android.Graphics.Color;

[assembly: ExportRenderer(typeof(MainPage), typeof(MainViewRenderer))]
namespace XAFApp.Droid.Renderers
{
    public class MainViewRenderer : VisualElementRenderer<MainPage>, IOnTabClickListener
    {
        ...
        protected override void OnLayout(bool changed, int left, int top, int right, int bottom)
        {
            ...
            _bottomBar.Layout(0, bottom - barHeight, width, bottom);
